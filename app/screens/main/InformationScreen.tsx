...
const InformationScreen: React.FC<InformationScreenProps> = ({ navigation }) => {
        ...
        return (
          <View style={styles.tabContent}>
            ...
            <Text style={styles.description}>
              Machu Picchu es una ciudadela inca ubicada en las alturas de los Andes en Perú, sobre el valle del río Urubamba. Construida en el siglo XV y luego abandonada, es famosa por sus sofisticadas paredes de piedra seca que combinan enormes bloques sin el uso de mortero, edificios fascinantes que se relacionan con alineaciones astronómicas y sus vistas panorámicas. Su ubicación exacta sigue siendo un misterio.
            </Text>
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Información-descrip</Text>

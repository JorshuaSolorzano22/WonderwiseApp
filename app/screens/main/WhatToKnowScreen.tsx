...
interface WhatToKnowScreenProps {
  navigation: any;
}

type TabType = 'Información' | 'Multimedia' | 'Mapa';

const WhatToKnowScreen: React.FC<WhatToKnowScreenProps> = ({ navigation }) => {
        ...
        return (
          <View style={styles.tabContent}>
            <View style={styles.tabSection}>
              ...
              <Text style={styles.sectionHighlight}>Lo que debes saber</Text>
            ...
            <View style={styles.tipsContainer}>
              ...
              <View style={styles.tipItem}>
                <Text style={styles.tipText}>
                  La altitud puede afectar visitantes sensibles, tomar precauciones.
                </Text>
              </View>
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Información-debes saber</Text>

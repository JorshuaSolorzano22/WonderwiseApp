...
interface InformationOpinionsScreenProps {
  navigation: any;
}
...
const InformationOpinionsScreen: React.FC<InformationOpinionsScreenProps> = ({ navigation }) => {
  ...
  const reviews: Review[] = [
    {
      ...
      avatar: 'L',
      rating: 5,
      comment: 'Una experiencia increíble. La vista es impresionante y la energía del lugar es única. Recomiendo ir temprano para evitar multitudes.',
      date: '2 días atrás'
    },
    {
      id: 2,
      ...
      avatar: 'C',
      rating: 4,
      comment: 'Vale cada centavo. Lleven suficiente agua y protector solar. El recorrido puede ser agotador pero la vista compensa todo el esfuerzo.',
      date: '1 semana atrás'
    }
  ];
        ...
        return (
          <View style={styles.tabContent}>
            <View style={styles.tabSection}>
              ...
              <Text style={styles.sectionHighlight}>Opiniones</Text>
            </View>
                ...
                <View key={review.id} style={styles.reviewCard}>
                  <View style={styles.reviewHeader}>
                    <View style={styles.reviewerInfo}>
                      <View style={[styles.avatar, { backgroundColor: review.id === 1 ? '#007AFF' : '#4CAF50' }]}>
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Información-opiniones</Text>
...
export default InformationOpinionsScreen;